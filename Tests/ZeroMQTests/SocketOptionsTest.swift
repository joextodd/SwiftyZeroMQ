...
class SocketOptionsTest: XCTestCase {
    ...
    func testSubscribe() throws {
        ...
        XCTAssertEqual(socks[sub1], ZeroMQ.PollFlags.none)
        XCTAssertEqual(socks[sub2], ZeroMQ.PollFlags.pollIn)
        XCTAssertEqual(socks[sub3], ZeroMQ.PollFlags.none)
        ...
        XCTAssertEqual(socks[sub1], ZeroMQ.PollFlags.none)
        XCTAssertEqual(socks[sub2], ZeroMQ.PollFlags.pollIn)
        XCTAssertEqual(socks[sub3], ZeroMQ.PollFlags.pollIn)
    }
